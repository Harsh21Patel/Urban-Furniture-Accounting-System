      ...
      <main className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 pt-6 space-y-4">
        ...
        <div className="bg-white dark:bg-gray-900 border border-gray-200 dark:border-gray-800 rounded-md overflow-hidden print:hidden">
          {loading ? (
            ...
            <div className="text-center py-12 text-xs text-gray-500 dark:text-gray-400">No invoices generated yet.</div>
          ) : (
        ...
        {showViewModal && selectedInvoice && (
          <div className="fixed inset-0 z-50 bg-black/40 flex items-center justify-center p-4 print:static print:bg-white print:p-0">
            <div className="bg-white dark:bg-gray-900 border border-gray-200 dark:border-gray-800 rounded-md p-6 max-w-2xl w-full space-y-4 print:border-none print:shadow-none print:bg-white print:text-black">
              {/* Header */}
              <div className="flex justify-between items-start border-b border-gray-200 dark:border-gray-800 pb-3 print:border-gray-300">
                <div className="flex items-center gap-3">
                  <div className="w-8 h-8 rounded bg-primary text-white flex items-center justify-center font-bold">
                    <Building2 className="w-5 h-5" />
                  </div>
                  <div>
                    <h2 className="text-base font-bold text-gray-900 dark:text-white print:text-black">Urban Furniture System</h2>
                    <p className="text-xs text-gray-500 dark:text-gray-400 print:text-gray-600">Official Customer Sales Invoice</p>
                  </div>
                </div>
                <div className="text-right">
                  <span className="text-base font-bold text-primary dark:text-primary-dark print:text-primary">
              ...
              {/* Customer Details */}
              <div className="grid grid-cols-2 gap-4 bg-gray-50 dark:bg-gray-800/60 p-3 rounded-md border border-gray-200 dark:border-gray-800 print:bg-gray-50 print:border print:border-gray-200">
                <div>
                  <p className="text-[10px] text-gray-500 dark:text-gray-400 font-bold uppercase">Billed To:</p>
                  <p className="text-xs font-bold text-gray-900 dark:text-white print:text-black">
                ...
                <div className="text-right">
                  <p className="text-[10px] text-gray-500 dark:text-gray-400 font-bold uppercase">Status:</p>
                  <span className="px-2 py-0.5 rounded bg-emerald-50 text-emerald-800 dark:bg-emerald-900/30 dark:text-emerald-400 border border-emerald-200 dark:border-emerald-800 font-semibold text-xs uppercase">
              ...
              <div className="overflow-x-auto border border-gray-200 dark:border-gray-800 rounded-md">
                <table className="w-full text-left text-xs text-gray-700 dark:text-gray-300 print:text-black">
                  ...
                  <tfoot className="border-t border-gray-200 dark:border-gray-800 font-bold print:border-gray-300">
                    <tr>
                      <td colSpan={4} className="px-3 py-2 text-right uppercase text-gray-500 dark:text-gray-400">Total Invoice Amount:</td>
